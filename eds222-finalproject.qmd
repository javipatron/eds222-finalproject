...
mangrove_plots_summary <- mangrove_df |> 
  ...
  summarise(plot_size_m2 = unique(plot_size_m2),
            ...
            tot_samples = n(),
            mean_plant_size_cm = (mean(cd_chatting_m)*100),
            mean_tot_carbon_g_c = mean(total_tree_kg_c)*1000)
...
plots_2017 <- mangrove_2017 |> 
  ...
  summarise(sample_count = n(),
            mean_carbon_kg = mean(total_tree_kg_c),
...
ggplot(plots_2017, aes(x = plot_size_m2, y= sample_count, size= mean_carbon_kg , fill = plot_size_m2)) +
  geom_violin(alpha = 0.5) +
