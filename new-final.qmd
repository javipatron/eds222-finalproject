...
## **Question 2:** What is the density difference between sample sizes and what is the effect of variance in the calculated Total Tree Carbon (mg/ha).
...
In this case we wull use the pwr.t.test function for estimating sample size or power, as our data contains a two-sample t-test to compare the two means.
...
ggplot(random_table_test, aes(x= plot_size_m2, y = total_tree_mg_c_ha, col = plot_size_m2)) +
  ...
  labs(title = "Total Cabron per Tree (mg/ha)",
       ...
       caption = paste("Real means difference is:",round(effect_size_a,2),"(mg/ha)" ,"\nRandom difference between means is:", round(random_effect_size_a,2), "(mg/ha)"))
...
ggplot(random_table_test, aes(x= plot_size_m2, y = total_tree_mg_c_ha, col = plot_size_m2)) +
  ...
  labs(title = "Total Cabron per Tree (mg/ha)",
       subtitle = "Random sample size",
       caption = paste("Real means difference is:",round(effect_size_b,2),"(mg/ha)" ,"\nRandom difference between means is:", round(random_effect_size_b,2), "(mg/ha)"))
